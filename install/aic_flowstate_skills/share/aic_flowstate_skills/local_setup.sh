...
: ${AMENT_CURRENT_PREFIX:="/usr/local/google/home/kbalasundar/aic_ws/src/aic/install/aic_flowstate_skills"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aic_flowstate_skills/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/aic_flowstate_skills/environment/path.sh"
