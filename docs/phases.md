...
1.  **Locate the Template:** Navigate to `aic_model/aic_model/model_node.py` in the provided repository.
...
> **Note:** You can reference the template structure here: [aic_model/model_node.py](https://github.com/intrinsic-dev/aic/blob/yadu/docs/aic_model/aic_model/model_node.py)
