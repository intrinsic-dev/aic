...
#ifndef STOP_RECORDING_SKILL_H_
#define STOP_RECORDING_SKILL_H_
...
class StopRecordingSkill final : public intrinsic::skills::SkillInterface {
 public:
  /**
