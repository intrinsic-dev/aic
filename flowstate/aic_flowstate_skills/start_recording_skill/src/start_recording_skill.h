...
#ifndef START_RECORDING_SKILL_H_
#define START_RECORDING_SKILL_H_
...
class StartRecordingSkill final : public intrinsic::skills::SkillInterface {
 public:
  /**
...
#endif  // START_RECORDING_SKILL_H_
