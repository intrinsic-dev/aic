...
bool CartesianImpedanceAction::Compute(
  ...
  if (!ComputeNullspaceStiffnessTorque(
          params.nullspace_stiffness, params.nullspace_damping,
          params.nullspace_goal, current_joint_state, jacobian,
  ...
  if (params.activation_percentage > 0) {
    ...
    for (std::size_t k = 0; k < num_joints_; ++k) {
      ...
      joint_limit_avoidance_torque(k) = SingleJointAvoidanceTorque(
          joint_limits_[k].min_position, lower_activation_threshold,
          joint_limits_[k].max_position, upper_activation_threshold,
...
//==============================================================================
bool CartesianImpedanceAction::ComputeNullspaceStiffnessTorque(
  ...
  if (!ComputeSmoothRightPseudoInverse(jacobian, jacobian_pinv,
...
//==============================================================================
bool CartesianImpedanceAction::ComputeSmoothRightPseudoInverse(
...
//==============================================================================
double CartesianImpedanceAction::SingleJointAvoidanceTorque(
